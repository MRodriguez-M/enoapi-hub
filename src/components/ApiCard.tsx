      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-2 mb-2">
          <h3
            ...
            className="text-lg font-bold text-zinc-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 cursor-pointer transition-colors"
          >
            {api.name}
          </h3>
          <button
        ...
        <div
          onClick={() => onSelect(api)}
          className="cursor-pointer rounded-xl bg-gradient-to-br from-blue-50/70 to-indigo-50/40 dark:from-blue-950/30 dark:to-indigo-950/20 border border-blue-100 dark:border-blue-900/40 p-3 mb-4 transition-all hover:bg-blue-50 dark:hover:bg-blue-950/50"
        >
